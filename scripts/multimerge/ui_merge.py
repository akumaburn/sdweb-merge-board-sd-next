...
def on_ui_tabs():
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F1 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F2 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F3 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F4 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F5 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F6 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F7 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F8 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F9 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
                    ...
                    with gr.Row():
                        with gr.Column():
                            with gr.Row(variant="panel"):
                                ...
                                F10 = gr.Checkbox(value=True, interactive=True, label=f"(F{_line_number}) Save as float16")
    ...
    def on_clear_settings():
        _ret = [
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F1)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F2)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F3)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F4)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F5)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F6)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F7)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F8)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F9)"), gr.update(value="safetensors"),
            gr.update(value=""), gr.update(value=""), gr.update(value=""), gr.update(value=0.5), gr.update(value=S_TRIPLE_SUM), gr.update(value=True), gr.update(value="tmp(F10)"), gr.update(value="safetensors")
        ]
        return _ret
